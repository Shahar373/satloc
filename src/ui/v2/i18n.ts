...
const resources = {
  en: {
    translation: {
      ...
      plan: {
        ...
        captures: '1 · Captures',
        contacts: '2 · Downlink contacts',
        mode: 'Mode',
        sunElevation: 'Sun {{deg}}°',
        captureLabel: 'Imaging — {{mode}}',
        downlinkLabel: 'Downlink — {{station}}',
        contactHint:
          'Each selected contact downloads the unassigned captures listed as available before it. Add more captures by removing and reselecting that contact.',
        noContacts: 'Select a capture first. Later contacts will appear here.',
        contactDuration: '{{seconds}} s · peak elevation {{deg}}°',
        contactLoad: '{{count}} product(s) · {{used}} GB / {{capacity}} GB capacity',
        capacityFits: 'Capacity fits',
        capacityShort: 'Not enough capacity',
        addDownlink: 'Add downlink',
        moreContacts: 'Show more contacts',
        ready: 'Ready to run',
        needsReview: 'Complete the plan',
        peakStorage: 'Peak storage',
        remainingStorage: 'Onboard after plan',
        assignedCaptures: 'Downloads captures {{numbers}}',
        acceptWarning: 'I accept this prediction uncertainty',
        waiverReason: 'Reason for accepting',
        missingGeometry: 'Some selected captures are unavailable. Reload the workspace before running.',
        chooseDownlink: 'Choose a downlink',
        replaceHint: 'Loading this plan replaces the current run and its debrief. Your draft stays available.',
        confirmReplace: 'Replace run & load plan',
        run: 'Load plan into Train',
        runHint:
          'Training commands are preloaded. The draft and run stay during navigation; closing or reloading the app clears them.',
        title: 'Capture & downlink plan',
        opportunities: 'Opportunities ({{count}})',
        loading: 'Computing captures and ground contacts…',
        disclaimer:
        ...
        note: 'Choose captures, assign later downlinks, review the checks, then load your plan into Train.',
        offNadir: 'Off-nadir {{deg}}°',
        daylightYes: 'Day',
        daylightNo: 'Night',
        clean: 'Checks passed',
        findings: {
          IMG_INSUFFICIENT_LIGHT: 'Insufficient sunlight',
          CONTACT_TOO_SHORT_FOR_PRODUCT: 'Contact capacity exceeded',
          DOWNLINK_PRODUCT_MISSING: 'Product not available for downlink',
          PLAN_CAPTURE_REQUIRED: 'Select a capture',
          PLAN_DOWNLINK_REQUIRED: 'Assign a later downlink',
          PLAN_TASK_OVERLAP: 'Task windows overlap',
          PLAN_DUPLICATE: 'Duplicate task or contact',
          PLAN_INVALID_TIME: 'Invalid task times',
          PLAN_UNKNOWN_TARGET: 'Unknown target',
          PLAN_UNKNOWN_STATION: 'Unknown station',
          PLAN_INCOMPLETE_WINDOW: 'Incomplete forecast window',
          PLAN_PRODUCTS_REQUIRED: 'Select distinct products',
      ...
      train: {
        operatorTitle: 'Your capture & downlink plan',
        planHint:
          'Running the plan you loaded from Plan. Draft edits do not change this run. Restart repeats this same plan.',
      ...
      debrief: {
        ...
        planCommitted: 'Operator plan loaded and validated.',
        warningWaived: '{{task}} · {{warning}} accepted: {{reason}}',
        title: 'Run debrief',
  ...
  he: {
    translation: {
      ...
      plan: {
        browse: 'עיון בהזדמנויות',
        captures: '1 · צילומים',
        contacts: '2 · קשרי הורדה',
        mode: 'מצב צילום',
        sunElevation: 'גובה שמש {{deg}}°',
        captureLabel: 'צילום — {{mode}}',
        downlinkLabel: 'הורדה — {{station}}',
        contactHint:
          'כל קשר שנבחר מוריד את הצילומים הזמינים לפניו שטרם שויכו להורדה. כדי להוסיף אליו צילומים, הסר ובחר אותו מחדש.',
        noContacts: 'בחר צילום תחילה. קשרים מאוחרים יותר יופיעו כאן.',
        contactDuration: '{{seconds}} שנ׳ · גובה מרבי {{deg}}°',
        contactLoad: '{{count}} תוצרים · {{used}} GB מתוך קיבולת {{capacity}} GB',
        capacityFits: 'הקיבולת מספיקה',
        capacityShort: 'אין מספיק קיבולת',
        addDownlink: 'הוסף הורדה',
        moreContacts: 'הצג קשרים נוספים',
        ready: 'מוכנה להרצה',
        needsReview: 'השלם את התוכנית',
        peakStorage: 'שיא האחסון',
        remainingStorage: 'אחסון בסיום התוכנית',
        assignedCaptures: 'מוריד צילומים {{numbers}}',
        acceptWarning: 'אני מקבל את אי־הוודאות בתחזית',
        waiverReason: 'סיבת האישור',
        missingGeometry: 'חלק מהצילומים שנבחרו אינם זמינים. טען מחדש את המסך לפני הרצה.',
        chooseDownlink: 'בחר קשר הורדה',
        replaceHint: 'טעינת התוכנית תחליף את ההרצה הנוכחית ואת התחקיר שלה. הטיוטה תישאר זמינה.',
        confirmReplace: 'החלף הרצה וטען תוכנית',
        run: 'טען תוכנית לאימון',
        runHint:
          'פקודות האימון נטענות מראש. הטיוטה וההרצה נשמרות במעבר בין מסכים; סגירה או טעינה מחדש של האפליקציה מוחקת אותן.',
        title: 'תכנון צילום והורדה',
        opportunities: 'הזדמנויות ({{count}})',
        loading: 'מחשב הזדמנויות צילום וקשרי קרקע…',
        disclaimer:
        ...
        note: 'בחר צילומים, שייך להם הורדות מאוחרות יותר, בדוק את התוכנית וטען אותה לאימון.',
        offNadir: 'סטייה מהנדיר {{deg}}°',
        daylightYes: 'יום',
        daylightNo: 'לילה',
        clean: 'הבדיקות עברו',
        findings: {
          IMG_INSUFFICIENT_LIGHT: 'אין מספיק אור לצילום',
          CONTACT_TOO_SHORT_FOR_PRODUCT: 'חריגה מקיבולת הקשר',
          DOWNLINK_PRODUCT_MISSING: 'התוצר אינו זמין להורדה',
          PLAN_CAPTURE_REQUIRED: 'בחר צילום',
          PLAN_DOWNLINK_REQUIRED: 'שייך קשר הורדה מאוחר יותר',
          PLAN_TASK_OVERLAP: 'חפיפה בין חלונות משימה',
          PLAN_DUPLICATE: 'משימה או קשר כפולים',
          PLAN_INVALID_TIME: 'זמני משימה לא תקינים',
          PLAN_UNKNOWN_TARGET: 'יעד לא מוכר',
          PLAN_UNKNOWN_STATION: 'תחנה לא מוכרת',
          PLAN_INCOMPLETE_WINDOW: 'חלון תחזית חלקי',
          PLAN_PRODUCTS_REQUIRED: 'בחר תוצרים נפרדים',
      ...
      train: {
        operatorTitle: 'תוכנית הצילום וההורדה שלך',
        planHint: 'הרצת התוכנית שטענת ממסך התכנון. שינוי הטיוטה אינו משנה הרצה זו. התחלה מחדש חוזרת על אותה תוכנית.',
      ...
      debrief: {
        decisions: 'החלטות התכנון',
        planCommitted: 'תוכנית המפעיל נבדקה ונטענה.',
        warningWaived: '{{task}} · אושרה אזהרת {{warning}}: {{reason}}',
        title: 'תחקיר ההרצה',
