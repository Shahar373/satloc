...
- [ ] `npm test`
- [ ] `npm run build`
- [ ] `npm run test:e2e` (if the change touches the app, not just docs/config)
- [ ] Changes to `src/core/propagation`, `src/core/passes`, `src/core/imaging`, or
      ...
      reference or documented golden regression)
...
- [ ] `docs/adr/` has a new entry if this is an architectural decision
